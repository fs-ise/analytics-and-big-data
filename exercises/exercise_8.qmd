...
For this exercise, the course repository should contain a prepared subset ([data/imdb_reviews_sample.csv](https://github.com/fs-ise/analytics-and-big-data/raw/refs/heads/main/exercises/data/imdb_reviews_sample.csv)) with thefollowing columns:
