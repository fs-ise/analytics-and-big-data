...
* Try to complete the task relying only on the [pandas documentation for box plots](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.boxplot.html).
