...
TODO: prepare explanation of regression assumptions and diagnostics
TODO: include transformations at the end (see https://ds100.org/course-notes/loss-transformations/#transformations-of-linear-models)
...
- Check whether they yield the same results? (did we specify the model correctly? is there an error in the library?) - generally, validating results is an important skill
...
- step-by-step add/remove variables
-->