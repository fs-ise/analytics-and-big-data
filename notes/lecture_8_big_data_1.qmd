...
- Extend text analytics slides to illustrate "Relevance today" (moving towards a systems perspective; used in LLMs (as input); RAG (explain), information retrieval (e.g., obsidian))
...
- Reduce imdb dataset to 1500 or 2000 ? (faster computations of the dense vectors)
