...
## Feature generation: Sparse sepresentations (classical NLP)
...
TF-IDF (term frequency-inverse document frequency) measures how important a term is to a document relative to a corpus
  ...
  - $tf$ (ferm frequency): how often a term appears in a document
...
- Words are represented as **dense vectors** of real numbers  
  - e.g., **50–300 values per word**
- Similar words occurring in similar contexts get **similar vector representations**
