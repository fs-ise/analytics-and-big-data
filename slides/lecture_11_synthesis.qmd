...
![](../images/course_overview.png){width=60% fig-align=center}
...
::: {.column width="50%"}
<br>
![](../images/course_overview.png){width=100% fig-align=center}
:::
...
- Will the exam mainly focus on the key take aways from the slides and the key concepts? Is edge knowledge from the slides required?
...
- Interested in a thesis topic?  
  [Bachelor and master theses](TODO)
