...
- which architecture matches the structure of the data

:::

![](../images/neural_networks_features.png){width=50% fig-align=center}

## Python code example

The `sklearn` library provides basic feedforward networks, incluing  MLPClassifier and MLPRegressor.
...
Full example:
        ...
        class MLP(nn.Module):
            def __init__(self, input_dim, hidden_layers, output_dim):
                ...
                # 🔧 Depth & Width (change here!)
                for h in hidden_layers:
                    layers.append(nn.Linear(prev_dim, h))
                    layers.append(nn.ReLU())  # standard default
                    prev_dim = h
        ...
        # Example: change architecture here 👇
        model = MLP(
            input_dim=10,
