...
- **Distinguish between supervised and unsupervised learning approaches** and explain the role of labeled data in supervised machine learning.
- **Describe the core workflow of supervised machine learning**, including feature engineering, train–test splitting, model training, cross-validation, and evaluation — and explain why each step is necessary for generalizable results.
- **Assess and interpret the performance of classification models**, using metrics such as the confusion matrix, accuracy, precision, recall, F1 score, and related concepts such as overfitting and the bias–variance tradeoff.
- **Connect conceptual machine learning procedures to Python implementations**, including preprocessing, model training, and evaluation using scikit-learn.
...
# Supervised Machine Learning {data-stack-name="Supervised Machine Learning"}
...
## The Supervised Machine Learning Workflow (15 min)

Introduce the high-level pipeline:
...
# ML Algorithms {data-stack-name="Algorithms"}
