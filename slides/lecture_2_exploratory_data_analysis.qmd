...
process (pre-model), aims, techniques (graphical, non-gaphical, ...)
...
- Two readings on an interval scale cannot be added but calculating an average of such values is possible
...
show all (?) visulaizations covered on the previous slides
TBD: clustering?!
