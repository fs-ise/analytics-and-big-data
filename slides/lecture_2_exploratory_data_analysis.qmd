...
<table style="border-collapse:collapse; margin:auto; font-size:20px; text-align:center;">
  ...
  <tr>
    ...
    <td style="border:3px solid #444; padding:22px 28px; background:#f8f8f8;">
      scatter plots<br>grouped dot plots
    </td>
  </tr>
</table>
...
Conducting EDA and representing the “real world” in computer requires us to use appropriate data types.
...
::: {.column width="50%"}
![](../images/5015_associates-degrees-_correlates-with_comments-on-oversimplified-youtube-videos.png){width=70% fig-align="center" }
:::

::: {.column width="50%"}
![](../images/1775_wind-power-generated-in-taiwan_correlates-with_google-searches-for-i-am-tired.png){width=70% fig-align="center" }
:::
...
**Clustering** is a technique that automatically groups **similar observations** based on their characteristics.
...
- **Grouping similar products** based on purchasing patterns
- **Identifying behavioral patterns** in users
...
Clustering groups **observations into clusters based on similarity** across **multiple variables**.

**Input**

- Each observation is described by **multiple attributes (multivariate data)**  
- Example: customer spending on different product categories

$$x_i = (x_{i1}, x_{i2}, ..., x_{im})$$

Similarity between observations is typically measured using a **distance metric** (e.g., Euclidean distance).
...
Clustering algorithms will **always produce clusters**, even if the data has **no real structure**.

Therefore, clusters must be **evaluated and interpreted carefully**.
