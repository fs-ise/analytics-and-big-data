...
::: aside
Figure based on @HendrycksEtAl2025.
:::
...
- Why Jupyter/Codespaces? (other options?)
- explain setup
...
- Start Codespace in [fs-ise/analytics-and-big-data-notebooks](https://github.com/fs-ise/analytics-and-big-data-notebooks)

::: aside
You can use a local setup after this session (if it works on your machine).
:::
...
Kernel: select global env

TODO: download/save changes (and stop/delete codespace)


## TODO: reading/synthesis?
