...
where m = number of values (here two: light, strong), $t_i$ = number of data sets with strong or light wind (8 resp. 6), t = total number of data sets (14) and entropy(t) = entropy before splitting.

![](../images/slides_207_2_new.png){fig-align=center}
...
![](../images/slides_243.png){height=300px fig-align=center}
