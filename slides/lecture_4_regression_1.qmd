...
session: "Session 4"
date: "2026-03-30"
cover-image: "../images/coverpage_linear_regression.png"
execute:
  echo: false
  warning: false
  message: false
...
<!--
    TODO: include an example of a regression table with significace (p-value/stars/confidence intervals)?
-->
...
{{< qrcode "{{< var sessions.session_4.survey_url >}}" width=400 height=400 >}}

:::

<br><br>

[{{< var sessions.session_4.survey_url >}}]({{< var sessions.session_4.survey_url >}})
