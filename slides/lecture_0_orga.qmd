...
```{dot}
digraph DataAnalyticsCourse {

    rankdir=TB;
    node [shape=box, style="rounded", color="#003366", fontcolor="#000000"];
...
- You are expected to take complementary notes and read the recommended literature.7
