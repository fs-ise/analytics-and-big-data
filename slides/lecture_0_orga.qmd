...
flowchart LR
  ...
  subgraph Right["<b>Synthesis</b>"]
    direction TB
    S["<div align='center'><b>Integration and outlook</b></div>"]
  end

  subgraph Stack["<b>Analytics capability stack</b>"]
    direction LR
    D["<div align='center'><b>Data foundations</b><br/>Exploration and architecture</div>"]
    M["<div align='center'><b>Analytical models</b><br/>Regression · ML · Big Data</div>"]
    O["<div align='center'><b>Organizational deployment</b><br/>Governance</div>"]
    D --> M --> O
  end
